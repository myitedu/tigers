...
2) plus, minus, kupaytirish, bolish, qoldiq chiqarish......
...
/*var input = prompt("How are you Kamola?");

if (input == 'good') {
    alert("WOW. Good for you");
}else if(input == "bad"){
    alert("WOW. so sorry, I wish you the best");
}else{
    alert("I hope all is good with you");
}
*/
/*
let student = {
    "fullname": "Isroil Jalilov",
    "level": "medium",
    "grade": "6",
    "hobby": "punch",
    "calculate_points": function (points) {
        return points / 36;
    }
}
 let bio = student.fullname + " likes "+ student.hobby +" becouse punch is his hobby";
document.write(bio);*/
