...
<div class="container-fluid">
    ...
    <div class="nav-link">
        <a  href="http://newyork.local/projects/Alxorazmi/1Project.php">Home <span class="sr-only">(current)</span></a>
        ...
        <a  href="http://newyork.local/projects/Alxorazmi/Zuhra.php" role="button">Symptoms</a>
        ...
        <a  href="http://newyork.local/projects/Alxorazmi/Fotima.php" role="button">Donate</a>
    </div>
    <div id="menu_div">
        <div class="w_31">
